...
- **Volatility**: A hotspot exhibits volatility when strong connascence (timing, execution order, shared algorithms) makes behaviour sensitive to when and how work executes, forcing tightly coupled change sets across the participating code paths.
