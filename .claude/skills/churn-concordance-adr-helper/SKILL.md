...
- **Volatility**: Tight dependencies on timing, execution order, or shared algorithms make behaviour sensitive to when and how work executes, forcing tightly coupled change sets across the participating code paths.
