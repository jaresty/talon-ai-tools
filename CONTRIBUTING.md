...
- CI entrypoint: `scripts/tools/run_guardrails_ci.sh [--help|target]` runs the selected guardrail target (defaults to `guardrails`; override via target arg or `GUARDRAILS_TARGET`).
