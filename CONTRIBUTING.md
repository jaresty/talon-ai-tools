...
- Portable prompt CLI: run `make bar-completion-guard` (or rely on the guardrails targets above) whenever you touch prompt grammar/completion code to keep the `bar completion` pytest guard green.
