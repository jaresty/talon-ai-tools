...
Completeness (`completenessModifier`): `deep`, `full`, `gist`, `grow`, `max`, `minimal`, `narrow`, `prime`, `ration`, `skim`, `zoom`
Scope (`scopeModifier`): `act`, `assume`, `authority`, `cross`, `dam`, `fail`, `good`, `jobs`, `lever`, `mean`, `motifs`, `product`, `relations`, `stable`, `storage`, `struct`, `thing`, `time`, `view`
Method (`methodModifier`): `abduce`, `actors`, `adversarial`, `afford`, `align`, `amorph`, `analog`, `analysis`, `argue`, `atomic`, `automate`, `balance`, `behave`, `bias`, `boom`, `bound`, `calc`, `chain`, `cite`, `clash`, `cluster`, `collapse`, `compare`, `conjoin`, `control`, `converge`, `crystal`, `deduce`, `depends`, `diagnose`, `dimension`, `domains`, `drift`, `effects`, `eliminate`, `enforce`, `enter`, `experimental`, `falsify`, `field`, `flow`, `fourfold`, `gap`, `gate`, `gloss`, `grain`, `ground`, `grove`, `hollow`, `induce`, `inversion`, `ladder`, `lateral`, `mapping`, `mark`, `meld`, `melody`, `mesh`, `migrate`, `mint`, `mod`, `models`, `mu`, `navigate`, `objectivity`, `operations`, `orbit`, `order`, `origin`, `own`, `paradox`, `perturb`, `polar`, `preserve`, `prioritize`, `prism`, `probability`, `pulse`, `rebase`, `redact`, `reify`, `release`, `reset`, `rigor`, `ritual`, `robust`, `root`, `seep`, `sense`, `sever`, `shear`, `shift`, `shoshin`, `simulation`, `snag`, `split`, `spur`, `square`, `survive`, `sweep`, `systemic`, `thrust`, `trace`, `unknowns`, `verify`, `visual`, `winnow`, `yield`
Form (`formModifier`): `actions`, `activities`, `axiom`, `bug`, `bullets`, `cards`, `case`, `chart`, `cheatsheet`, `checklist`, `cocreate`, `commit`, `contextualise`, `coupling`, `dialogue`, `direct`, `elicit`, `facilitate`, `faq`, `formats`, `ghost`, `indirect`, `interactive`, `log`, `merge`, `ontology`, `prep`, `questions`, `quiz`, `recipe`, `reel`, `scaffold`, `scorecard`, `slides`, `snap`, `socratic`, `spike`, `stage`, `story`, `storyboard`, `table`, `taxonomy`, `template`, `test`, `tight`, `timeline`, `twin`, `variants`, `vet`, `walkthrough`, `wardley`, `wasinawa`
Channel (`channelModifier`): `adr`, `agent`, `aloud`, `browse`, `canvas`, `code`, `codetour`, `demo`, `diagram`, `draw`, `formal`, `gherkin`, `github`, `html`, `hunk`, `image`, `jira`, `ledger`, `notebook`, `notion`, `plain`, `presenterm`, `remote`, `shellscript`, `sketch`, `skill`, `slack`, `store`, `svg`, `sync`, `video`, `zettel`
