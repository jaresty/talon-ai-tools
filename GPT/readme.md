...
Form (`formModifier`): `actions`, `activities`, `bug`, `bullets`, `cards`, `case`, `chart`, `cheatsheet`, `checklist`, `cocreate`, `commit`, `contextualise`, `coupling`, `dialogue`, `direct`, `facilitate`, `faq`, `formats`, `ghost`, `indirect`, `interactive`, `log`, `merge`, `prep`, `questions`, `quiz`, `recipe`, `reel`, `scaffold`, `scorecard`, `slides`, `snap`, `socratic`, `spike`, `stage`, `story`, `table`, `taxonomy`, `template`, `test`, `tight`, `timeline`, `twin`, `variants`, `vet`, `walkthrough`, `wardley`, `wasinawa`
Channel (`channelModifier`): `adr`, `agent`, `aloud`, `code`, `codetour`, `demo`, `diagram`, `draw`, `formal`, `gherkin`, `github`, `html`, `hunk`, `image`, `jira`, `ledger`, `notebook`, `plain`, `presenterm`, `remote`, `shellscript`, `sketch`, `skill`, `slack`, `store`, `svg`, `sync`, `video`, `zettel`
