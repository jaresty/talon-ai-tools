...
Completeness (`completenessModifier`): `deep`, `full`, `gist`, `grow`, `max`, `minimal`, `narrow`, `skim`, `triage`, `zoom`
Scope (`scopeModifier`): `act`, `agent`, `assume`, `cross`, `dam`, `fail`, `good`, `mean`, `motifs`, `stable`, `storage`, `struct`, `thing`, `time`, `view`
Method (`methodModifier`): `abduce`, `actors`, `adversarial`, `afford`, `align`, `amorph`, `analog`, `analysis`, `argue`, `automate`, `balance`, `bias`, `boom`, `bound`, `calc`, `cite`, `clash`, `cluster`, `compare`, `control`, `converge`, `crystal`, `deduce`, `depends`, `diagnose`, `dimension`, `domains`, `drift`, `effects`, `experimental`, `field`, `flow`, `gap`, `ground`, `grove`, `induce`, `inversion`, `jobs`, `mapping`, `mark`, `meld`, `melody`, `mesh`, `migrate`, `mint`, `mod`, `models`, `objectivity`, `operations`, `order`, `origin`, `perturb`, `polar`, `preserve`, `prioritize`, `probability`, `product`, `pulse`, `reify`, `release`, `reset`, `resilience`, `rigor`, `risks`, `ritual`, `robust`, `root`, `seep`, `sever`, `shear`, `shift`, `simulation`, `snag`, `split`, `spur`, `sweep`, `systemic`, `thrust`, `trace`, `unknowns`, `verify`, `yield`
Form (`formModifier`): `actions`, `activities`, `bug`, `bullets`, `cards`, `case`, `checklist`, `cocreate`, `commit`, `contextualise`, `coupling`, `direct`, `facilitate`, `faq`, `formats`, `ghost`, `indirect`, `ladder`, `log`, `merge`, `persist`, `prep`, `questions`, `quiz`, `recipe`, `scaffold`, `sense`, `socratic`, `spike`, `story`, `table`, `taxonomy`, `test`, `tight`, `timeline`, `twin`, `variants`, `vet`, `visual`, `walkthrough`, `wardley`, `wasinawa`
