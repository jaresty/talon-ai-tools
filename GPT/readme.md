...
Method (`methodModifier`): `abduce`, `actors`, `adversarial`, `afford`, `align`, `amorph`, `analog`, `analysis`, `argue`, `balance`, `bias`, `boom`, `bound`, `branch`, `calc`, `canon`, `cite`, `clash`, `cluster`, `compare`, `control`, `converge`, `crystal`, `deduce`, `depends`, `derive`, `diagnose`, `dimension`, `domains`, `drift`, `effects`, `entangle`, `experimental`, `explore`, `field`, `flow`, `gap`, `grove`, `grow`, `induce`, `inversion`, `jobs`, `mapping`, `meld`, `melody`, `mod`, `models`, `objectivity`, `operations`, `order`, `origin`, `perturb`, `polar`, `prioritize`, `probability`, `product`, `reify`, `release`, `resilience`, `rigor`, `risks`, `robust`, `sever`, `shift`, `simulation`, `spec`, `spill`, `split`, `systemic`, `trade`, `trans`, `triage`, `unknowns`, `verify`
