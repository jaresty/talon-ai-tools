...
Method (`methodModifier`): `abduce`, `actors`, `adversarial`, `afford`, `align`, `amorph`, `analog`, `analysis`, `argue`, `balance`, `bias`, `boom`, `bound`, `branch`, `calc`, `canon`, `cite`, `clash`, `cluster`, `compare`, `control`, `converge`, `crystal`, `deduce`, `depends`, `derive`, `diagnose`, `dimension`, `domains`, `drift`, `effects`, `entangle`, `experimental`, `explore`, `field`, `flow`, `gap`, `ground`, `grove`, `grow`, `induce`, `inversion`, `jobs`, `mapping`, `meld`, `melody`, `migrate`, `mod`, `models`, `objectivity`, `observe`, `operations`, `order`, `origin`, `perturb`, `polar`, `preserve`, `prioritize`, `probability`, `product`, `reify`, `release`, `reset`, `resilience`, `rigor`, `risks`, `robust`, `sever`, `shift`, `simulation`, `spill`, `split`, `systemic`, `trace`, `trade`, `trans`, `triage`, `unknowns`, `verify`
