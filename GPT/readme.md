...
Channel (`channelModifier`): `adr`, `code`, `codetour`, `diagram`, `draw`, `formal`, `gherkin`, `html`, `image`, `jira`, `notebook`, `plain`, `presenterm`, `remote`, `shellscript`, `sketch`, `slack`, `store`, `svg`, `sync`, `video`
