...
Scope (`scopeModifier`): `act`, `fail`, `good`, `mean`, `motifs`, `struct`, `thing`, `time`, `view`
Method (`methodModifier`): `abduce`, `actors`, `adversarial`, `analog`, `analysis`, `argue`, `bias`, `boom`, `branch`, `calc`, `cite`, `constraints`, `converge`, `deduce`, `depends`, `diagnose`, `dimension`, `domains`, `dynamics`, `effects`, `experimental`, `explore`, `flow`, `grove`, `grow`, `incentives`, `induce`, `interfaces`, `inversion`, `jobs`, `mapping`, `meld`, `melody`, `mod`, `models`, `objectivity`, `operations`, `order`, `origin`, `prioritize`, `probability`, `product`, `quiz`, `resilience`, `rigor`, `risks`, `robust`, `roles`, `shift`, `simulation`, `spec`, `split`, `systemic`, `unknowns`, `verify`
