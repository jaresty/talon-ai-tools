...
Method (`methodModifier`): `abduce`, `actors`, `adversarial`, `afford`, `align`, `amorph`, `analog`, `analysis`, `argue`, `automate`, `balance`, `bias`, `boom`, `bound`, `calc`, `cite`, `clash`, `cluster`, `compare`, `control`, `converge`, `crystal`, `deduce`, `depends`, `diagnose`, `dimension`, `domains`, `drift`, `effects`, `experimental`, `field`, `flow`, `gap`, `ground`, `grove`, `induce`, `inversion`, `jobs`, `ladder`, `mapping`, `mark`, `meld`, `melody`, `mesh`, `migrate`, `mint`, `mod`, `models`, `objectivity`, `operations`, `order`, `origin`, `perturb`, `polar`, `preserve`, `prioritize`, `probability`, `product`, `pulse`, `reify`, `release`, `reset`, `resilience`, `rigor`, `risks`, `ritual`, `robust`, `root`, `seep`, `sense`, `sever`, `shear`, `shift`, `simulation`, `snag`, `split`, `spur`, `sweep`, `systemic`, `thrust`, `trace`, `unknowns`, `verify`, `visual`, `yield`
Form (`formModifier`): `actions`, `activities`, `bug`, `bullets`, `cards`, `case`, `checklist`, `cocreate`, `commit`, `contextualise`, `coupling`, `direct`, `facilitate`, `faq`, `formats`, `ghost`, `indirect`, `log`, `merge`, `persist`, `prep`, `questions`, `quiz`, `recipe`, `scaffold`, `socratic`, `spike`, `story`, `table`, `taxonomy`, `test`, `tight`, `timeline`, `twin`, `variants`, `vet`, `walkthrough`, `wardley`, `wasinawa`
Channel (`channelModifier`): `adr`, `code`, `codetour`, `diagram`, `draw`, `gherkin`, `html`, `image`, `jira`, `notebook`, `plain`, `presenterm`, `remote`, `shellscript`, `sketch`, `slack`, `svg`, `sync`, `video`
