...
if bootstrap is not None:
    from talon_user.lib.axisCatalog import serialize_axis_config, AXIS_KEY_TO_VALUE
    ...
    class AxisCatalogSerializerTests(unittest.TestCase):
        def test_serializes_axes_without_style(self):
            ...
            self.assertEqual(axes, AXIS_KEY_TO_VALUE)
        ...
        def test_serializes_axis_lists_from_talon_files(self):
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                for token in AXIS_KEY_TO_VALUE["completeness"].keys():
