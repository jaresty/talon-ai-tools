...
BASELINE_RUNG_SEQUENCE_CODE_CHARS = 23800  # ADR-0179: ~1117; ADR-0180: ~500; ADR-0181: ~900; ADR-0182: ~770; formal notation separation; OBR live-process fix: +149; L1-L6 drift closures: +578
