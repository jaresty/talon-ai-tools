...
class ModelPatternGUIGuardTests(unittest.TestCase):
    def test_pattern_gui_actions_respect_in_flight_guard(self):
        ...
        with (
            ...
            patch.object(pattern_module.actions.user, "confirmation_gui_save_to_file") as save_file,
            patch.object(pattern_module, "pattern_debug_view", create=True) as debug_view,
        ):
