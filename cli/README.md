...
- `drop_reason`: when present, the adapter calls `set_drop_reason()` with the severity-prefixed message so Concordance guardrails and history exports reflect the CLI outcome.
