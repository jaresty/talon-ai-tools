...
- Scheduler telemetry: each export now records scheduler reschedule stats in the telemetry payload and marker, so CLI guardrails can surface cadence drift and last reschedule reasons, and job summaries embed the JSON snapshot.
