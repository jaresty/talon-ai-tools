...
3. **Request Gating & Streaming Lifecycle**
    ...
    - (Updated 2025-12-23) Guardrail CLI now fails immediately when the telemetry export marker is missing, invalid, or stale, printing a reminder to run `model export telemetry` inside Talon before rerunning guardrails. The former streak log (`artifacts/telemetry/cli-warning-streak.json`) has been removed.
