...
- loop-0083 — persisted HTTP telemetry artefact recording, added HTTP header injection, and refreshed parity coverage for provider sentinel and telemetry persistence; validation: `python3 -m pytest _tests/test_cli_talon_parity.py`, `python3 -m pytest _tests/test_cli_talon_parity.py::CLITalonParityTests::test_cli_delegate_http_custom_headers`, `python3 -m pytest _tests/test_cli_talon_parity.py::CLITalonParityTests::test_cli_delegate_http_persists_latency_telemetry`; evidence: `docs/adr/evidence/0063/loop-0083.md`.
- loop-0084 — captured HTTP provider transcripts to disk with bounded rotation and parity coverage; validation: `python3 -m pytest _tests/test_cli_talon_parity.py::CLITalonParityTests::test_cli_delegate_http_records_fixture_artifact`, `python3 -m pytest _tests/test_cli_talon_parity.py::CLITalonParityTests::test_cli_delegate_http_record_rotation_limit`, `python3 -m pytest _tests/test_cli_talon_parity.py`; evidence: `docs/adr/evidence/0063/loop-0084.md`.
- loop-0085 — applied HTTP transcript redaction, added packaging command, and extended parity coverage; validation: `python3 -m pytest _tests/test_cli_talon_parity.py::CLITalonParityTests::test_cli_delegate_http_record_redacts_patterns`, `python3 -m pytest _tests/test_cli_talon_parity.py::CLITalonParityTests::test_cli_recordings_export_generates_bundle`, `python3 -m pytest _tests/test_cli_talon_parity.py`; evidence: `docs/adr/evidence/0063/loop-0085.md`.
