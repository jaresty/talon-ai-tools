...
PY` | status: in_progress — loop-0027 adds CLI health probe gating with persisted failure counters; next slice feeds counters into adapter UI/backoff telemetry.
