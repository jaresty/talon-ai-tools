...
- Add an in-app shortcut reference (`Ctrl+?`) that surfaces grouped commands, focus toggles, and section controls without leaving the TUI.
...
## Validation
- `go test ./internal/bartui` to cover focus breadcrumbs, sidebar toggles, history metadata, and collapsible sections.
