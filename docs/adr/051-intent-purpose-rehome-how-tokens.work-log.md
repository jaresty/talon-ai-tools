...
- Changes:
  - Removed non-Why intent tokens from intent SSOT and Talon list (`lib/personaConfig.py`, `GPT/lists/modelIntent.talon-list`); dropped the `collaborate` intent preset/bucket entry to keep presets aligned with the trimmed intent axis.
