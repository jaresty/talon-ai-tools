...
- Press `Ctrl+P` to open the token palette for faster browsing and preset resets; type “copy command” to run the clipboard action, and press `Ctrl+W` at any time to clear the palette filter.
