...
func renderQuickStart(w io.Writer, compact bool) {
	...
	fmt.Fprintf(w, "bar lookup \"explain to audience\" --subject \"auth code to my manager\"          # rerank matches by context\n")
	fmt.Fprintf(w, "bar lookup \"explain to audience\" --subject \"auth code\" --addendum \"for a non-technical audience\" --json  # context_score shows fit\n")
