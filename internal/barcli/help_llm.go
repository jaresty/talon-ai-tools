...
func renderLLMSequencesSection(w io.Writer, grammar *Grammar, compact bool) {
	...
	fmt.Fprintf(w, "**Executing a dispatch step** — run `bar help dispatch` to load the live numbered protocol. The output is authoritative — do not improvise from memory or from this section's prose.\n\n")
