...
func renderQuickStart(w io.Writer, compact bool) {
	...
	fmt.Fprintf(w, "# --addendum = the task directive (what you want done with it, and for whom)\n")
	...
	fmt.Fprintf(w, "bar lookup --subject \"JWT validation Go middleware\" --addendum \"explain to a junior engineer\"  # what+for whom\n")
	fmt.Fprintf(w, "bar lookup --subject \"JWT validation\" --addendum \"explain to junior\" --axis task  # scoped to task axis\n")
