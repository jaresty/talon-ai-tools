...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "single unambiguous denotation: two independent readers must reach the same conclusion about what satisfies it. Each property must be atomic. A split of a property into parts "
