...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "require additional effort, introduce failure risk, or be blocked. The response applies a meta-process discipline before any implementation action, deriving and enforcing its "
        "own correctness conditions as transcript-inspectable strings. A rung is satisfied when and only when a tool-executed event matching its definition appears in the transcript — "
