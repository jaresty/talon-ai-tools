...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "Rung manifest complete' on its own line before any artifact. Boundary: the manifest is the first and only output before this phrase — no tool calls, domain exploration, "
