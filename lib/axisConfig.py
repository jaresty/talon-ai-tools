...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "revision — a constraint conflict, a pivot forced by implementation, or new information discovered during descent — update the rung above before re-deriving the current rung; "
        "the ladder must remain consistent at every boundary. A rung is an "
