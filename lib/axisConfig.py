...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "rung: assertion rung failures must be due to actual gaps, not infrastructure issues; RULE: validation tests must pass before moving to assertion rung [ ] Smallest intent at "
