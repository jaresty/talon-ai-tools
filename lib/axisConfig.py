...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "work. IMPORTANT: Baseline establishes ALL evaluation mechanics AND may create minimal scaffolding to hold them. This scaffolding is NOT the solution - it's just enough to "
        "verify evaluation works. Baseline must PASS with its scaffolding. IMPORTANT: Baseline evaluation must be SELF-CONTAINED. If it fails due to missing prerequisites, that's a "
