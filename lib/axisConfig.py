...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "ending — (5) enumerate escape paths: after '§ enforcement complete', immediately write '## Path enumeration' — '## Path enumeration' must not appear before '§ enforcement "
        ...
        "non-empty. A turn whose final non-blank content line contains or follows one of these strings and does not end with one of the three exit strings does not satisfy ground. When "
        "the continuation invariant applies, it governs the turn exclusively — no other turn-ending requirement applies. A rung-completion string may not appear as the final non-blank "
        "content line of a turn; a turn whose final non-blank content line is a rung-completion string and not one of the three exit sentinels does not satisfy the continuation "
        "invariant.",
