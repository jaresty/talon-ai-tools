...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "this phrase, execution must begin at Rung 1 of Thread 1 — no rung may be skipped on grounds of perceived simplicity, prior knowledge, other active constraint tokens, or "
