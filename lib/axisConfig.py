...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "verified'; any assistant turn that contains a question directed at the user or no further planned tool calls, after '§ implementation permitted' has appeared in the "
        "transcript, must contain '## Completion check' before that question or closing text — a turn whose question or closing text appears before '## Completion check' does not "
