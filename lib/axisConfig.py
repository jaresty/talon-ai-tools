...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "Then move to implementation rung. Implementation rung: AFTER assertion rung shows red, implement to make that specific assertion green — this will build the COMPLETE component "
        "needed to satisfy that assertion (not just stub); take the perspective of an adversarial implementer; implement what the test demands; tests drive the behavior needed. Emit "
