...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "executable validation (artifact written to target the declared gap and reveal whether it has been closed — tests, types, contracts, schemas, or property checks; pre-existing artifacts not targeting the gap do not satisfy this rung) → "
