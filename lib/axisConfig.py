...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "tool are invalid]' on their own lines; non-executable rung observations appear inline as prose — these sentinels apply only to executable rungs and gate the immediately "
