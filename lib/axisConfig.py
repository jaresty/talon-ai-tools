...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "NOT the solution itself. Baseline = criteria definition and scaffolding, not implementation. IMPORTANT: Baseline PASS means evaluation structure FUNCTIONS, not that task is "
        "complete. Baseline passes if evaluation works without errors - nothing more. Solution comes later through iteration. IMPORTANT: Baseline creates MINIMAL scaffolding only. If "
