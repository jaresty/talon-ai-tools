...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "'§4 coverage verified' does not satisfy this requirement and the governed turn must continue to the next derived step rather than ending; (5) enumerate escape paths: '## Path "
