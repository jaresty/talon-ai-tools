...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "the first rung — I is not an artifact; artifacts are derived from I) — the form changes, the intent does not — such that any proposed output O can be accepted or rejected against V without consulting I again. Faithful derivation "
