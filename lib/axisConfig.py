...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "form": {
        ...
        "their expectation before the answer is shown), then write the answer. After each answer: a gap-reveal sentence comparing what the Predict: line stated against what is correct or "
        ...
        "the question the next concept answers (evaluator check: the quoted phrase appears verbatim in the current answer); a Hook: line must not appear after the last concept's answer; "
        "then for at least one concept per quiz, a Misconception: line naming the specific incorrect belief that would lead a reader to predict the wrong answer, and a Why: line stating "
        ...
        "output-exclusive channel, structure the output as a quiz document with each question immediately before its answer per topic.",
