...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "call — no content (blank lines, prose, or tool-call blocks) may appear between the sentinel and the `(i)` line; no user message appearing between § implementation permitted "
        "[N] and the governed tool call satisfies this requirement — a sentinel written in one turn and a tool call appearing in a later turn after a user message does not satisfy the "
        ...
        "character; each of the strings '§0 observed', '§1 goal derived', '§1a decomposed', '§1b candidates', '§2 dimensions closed', '§ formalization complete', '§4 coverage "
