...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "label; a second criterion for the same thread is a protocol violation — stop, return to the prose rung, and split the thread before descending again. The formal notation rung "
