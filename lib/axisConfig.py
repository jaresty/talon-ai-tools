...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "from P1-P6; rules that cannot be derived are protocol violations; Protocol derived must be emitted AFTER deriving all protocol rules from P1-P6 — omitting derivation or "
