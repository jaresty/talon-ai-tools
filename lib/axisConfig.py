...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "relative to the governing artifact citation. The FAIL must be produced by running an artifact that (a) is written to assert that specific behavior and (b) executes when the "
