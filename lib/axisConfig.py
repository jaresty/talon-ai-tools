...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    "channel": {
        ...
        "gherkin": "The response outputs only Gherkin format as the complete output, using Jira markup where appropriate and omitting surrounding explanation.",
    ...
    "form": {
        ...
        "bug": "The response structures ideas as a bug report with sections for Steps to Reproduce, Expected Behavior, Actual Behavior, and Environment or Context, emphasizing concise, testable details.",
        ...
        "cocreate": "The response structures interaction collaboratively, proposing small moves, checking alignment, and iterating together instead of delivering a one-shot answer.",
        ...
        "contextualise": "The response structures ideas by adding or reshaping context to support another operation—such as supplying background for an LLM or reframing content—without rewriting the main text itself.",
        ...
        "facilitate": "The response structures interaction by framing the goal, proposing structure, managing turns, and keeping participation balanced rather than doing the work solo.",
        ...
        "taxonomy": "The response structures ideas as a classification system, type hierarchy, or category taxonomy, defining types, their relationships, and distinguishing attributes clearly.",
    ...
    "method": {
        ...
        "constraints": "The response enhances the task by identifying the system's primary constraints, analyzing the behaviours they enforce, and framing ways to balance or relieve them.",
        ...
        "dynamics": "The response enhances the task by concentrating on how the system's behaviour and state evolve over time, including transitions and feedback.",
        ...
        "grove": "The response enhances the task by examining accumulation, decay, or rate-of-change effects and how small contributions compound over time.",
        "incentives": "The response enhances the task by analyzing explicit and implicit incentive structures and how they drive behaviour.",
        "interfaces": "The response enhances the task by concentrating on external interfaces, contracts, and boundaries between components or systems.",
        ...
        "motifs": "The response enhances the task by identifying recurring patterns, themes, or clusters and explaining why they matter.",
        ...
        "order": "The response enhances the task by applying abstract structural reasoning such as hierarchy, dominance, or recurrence.",
        ...
        "roles": "The response enhances the task by focusing on responsibilities, ownership, and collaboration patterns.",
        "simulation": "The response develops explicit thought experiments or scenario walkthroughs that project evolution over time, highlighting feedback loops, bottlenecks, tipping points, and emergent effects.",
        "systemic": "The response enhances the task by analyzing the subject as a whole system, identifying components, boundaries, flows, and feedback loops.",
    ...
    "scope": {
        "act": "The response focuses on what is being done or intended—tasks, activities, operations, or work to be performed—rather than structure or meaning.",
        "fail": "The response focuses on breakdowns, stress, uncertainty, or limits—risks, edge cases, pain points, resilience, or what can go wrong.",
        "good": "The response focuses on how quality, success, or goodness is judged—criteria, metrics, value, taste, or standards of assessment.",
        "mean": "The response focuses on why something exists or how it should be understood—purpose, assumptions, framing, terminology, or interpretive lens.",
        "struct": "The response focuses on how things are arranged or related—dependencies, coordination, constraints, incentives, or organizing patterns.",
        "thing": "The response focuses on what things are in view—objects, people, roles, systems, domains, or bounded units—without emphasizing actions or evaluation.",
        "time": "The response focuses on when things occur and how they change over time—sequences, evolution, history, or temporal dynamics.",
    },
}
