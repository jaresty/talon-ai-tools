...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "original state. For every executable assertion the tool-result must produce an outcome attributable to that assertion alone; a whole-guard execution that does not yield "
        ...
        "execution to anchor to. 'Coverage: complete' is valid only when every enumerated assertion has a verbatim-matching observed 'Failure:' line or 'Unobservable: … — structural' "
        "line, and no 'Overreach: found' remains open.",
