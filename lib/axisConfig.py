...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "conversation output? if not, do not emit it — produce the executable validation artifact instead. At the criteria rung, state only the conditions that close the declared gap — "
        "do not enumerate all requirements of the task. Formal notation encodes only the criteria declared at the criteria rung — no additional invariants, no anticipated cases. Only "
