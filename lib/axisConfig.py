...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "general discourse about the domain. Do not name the tension or state that something cannot be resolved. The response succeeds if the reader is held inside the irresolution rather "
