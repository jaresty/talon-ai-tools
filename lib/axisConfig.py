...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "the same generative act does not satisfy this requirement. The ladder must be a completed artifact in the transcript before the rung 1 coverage mapping begins. The artifact is "
        "an enumerated list of rungs, each stating: the rung name, the artifact type produced at that rung, the condition under which the rung is satisfied — including the specific "
        "state of the artifact that would cause the satisfaction condition to evaluate to false; a satisfaction condition entry that cannot name its false-evaluating state has not been "
