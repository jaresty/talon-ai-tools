...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "artifact; emit 'Implementation overreach: found — <modification>' or 'Implementation overreach: not found'; if found, minimally revise the implementation to eliminate the "
