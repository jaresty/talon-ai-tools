...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "run, naming its speed tier (unit, integration, or e2e); second, name at least one insufficient check — a faster or lighter check that would not catch this behavior — and "
