...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "this behavior but is more expensive — if no such slower check exists above this line, the candidate is not justified as minimal; second, name the candidate check — the "
