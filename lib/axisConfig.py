...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "tests to match implementation. If tests are wrong, return UP to validation rung to fix them; modifying tests in later rungs voids the rung. Rung completion MUST be emitted as: "
