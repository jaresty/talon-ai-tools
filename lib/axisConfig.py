...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "validation rung — no other content is permitted before ✅ Validation artifact V complete; each test function contains exactly one assertion — one assertion per test function; "
