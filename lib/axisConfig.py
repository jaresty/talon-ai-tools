...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "The leak check runs over every context's conclusions AND every Message's forwarded content.  (3) Reason: reason about the subject using the default and admit frames, "
        ...
        "no disposition lines has not established that its frame set was chosen rather than inherited; a response containing a delegation tool-use block with no disposition lines at "
        "an earlier transcript position does not satisfy this token.",
