...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "not per thread. P18 (Intent logging): Every file edit requires 🔵 Intent logged + 🔵 Intent achieved pair with matching ids — the intent pair provides auditability inline "
