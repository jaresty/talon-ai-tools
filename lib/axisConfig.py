...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "✅ Thread N complete, check: does the prose rung for this thread describe any behavioral properties not yet covered by a completed gap cycle? If so, emit a new 🔴 Gap: naming "
        "the next unmet behavior and begin the next cycle at the criteria rung. Outputting a rung label is what begins that rung — it is not a heading or annotation; a rung whose label "
