...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "conversation output? if not, do not emit it — produce the executable validation artifact instead. Only validation artifacts may be produced at the executable validation rung — "
