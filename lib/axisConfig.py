...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "satisfy ground; (5) enumerate escape paths: '## Path enumeration' must not appear before '## Enforcement sequence' in the transcript; enumerate every path by which §1–§4 "
