...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "observation requires tool-based execution, not conversational acknowledgment. The response treats the declared intent (I) as fixed. At each step, the response produces a "
