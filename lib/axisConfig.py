...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "process, not on the process structure itself — they govern depth, scope, and style at each step but cannot eliminate steps or the manifest. When a rung reveals the rung above "
