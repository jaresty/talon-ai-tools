...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "follow it. Continuation invariant: when the final non-blank content line of a turn contains or follows one of the rung-completion strings '§0 observed', '§1 goal derived', '§2 "
        "dimensions closed', '§4 coverage verified', or '§5 enumeration complete', that turn must end with one of: '§ blocked: <text>', '§ awaiting: <text>', or '§ no-next-action: "
        "<text>', where '<text>' is non-empty. A turn whose final non-blank content line contains or follows one of these strings and does not end with one of the three exit strings "
        "does not satisfy ground.",
