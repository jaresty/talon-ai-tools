...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "MISSING - nothing more. A gap saying 'component doesn't exist' means just that: it doesn't exist. It does NOT mean create the full component. [ ] Structure before Challenge: "
        ...
        "requires?]. If gaps remain or verification not shown, do NOT proceed. Protocol derived MUST be emitted as: 🔵 Protocol derived — AFTER deriving all rules from P1-P5. Ladder "
