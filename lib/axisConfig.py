...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "Ground complete; UPWARD SCAN MUST produce an explicit checklist with each criterion marked: ✅ addressed or ❌ gap remains — missing this checklist is a protocol violation), "
