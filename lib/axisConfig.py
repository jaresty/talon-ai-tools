...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "properties complete' is valid only after a valid '§ properties check:' line has appeared; (4) verify coverage: '## Completion check' must appear as the next heading after '§5 "
        ...
        "'§5 enumeration complete'; '§5 enumeration complete' must not appear before a valid '§5 check:' line in the transcript; any referent named in the '[text]' from §1 not already "
