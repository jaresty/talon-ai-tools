...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "confirmed formal in the final check is the canonical definition for this property — no subsequent step may quote a definition not yet confirmed formal. Step 2 — Introduce "
        ...
        "completeness check. Only when every explicit request constraint is represented by at least one retained property may the response emit '§ properties complete? yes' — a '§ "
