...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "directional": {
        ...
        "reveals.",
        "fog": "The response additionally orients toward the abstract and general — identifying patterns and principles that transcend the specifics, reaching toward broader insights.",
