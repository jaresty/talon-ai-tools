...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {'completeness': {'full': 'Important: Provide a thorough answer for normal use; cover all major aspects, but you do '
 ...
 'directional': {'bog': 'Important: Frame the preceding prompt through one unified perspective that blends acting, '
                 ...
                 'rog': 'Important: Apply a reflective-structural perspective as one synthesized lens to frame the '
                        'preceding prompt.'},
 'method': {'adversarial': 'Important: Run a constructive stress-test: systematically search for weaknesses, edge '
 ...
 'scope': {'actions': 'Important: Within the selected target, focus only on concrete actions or tasks that a user or '
 ...
 'style': {'abstractvisual': 'Important: Express the big picture as an abstract visual or metaphorical layout (for '
