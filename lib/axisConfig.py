...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "sentinel), each derived rule must cite its source principle(s) from P1-P6; rules that cannot be derived are protocol violations; emit Protocol derived after deriving all "
