...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "a file whose modification would change the outcome of any execution result in the transcript — a file is governed if its modification changes any such result, regardless of "
        ...
        "appears after any such modification is not valid regardless of its position relative to the governing artifact citation. The FAIL must be produced by running an artifact that "
