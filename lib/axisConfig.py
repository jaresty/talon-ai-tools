...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "mu": "The response states the central tensions of the subject as a set of claims that resist logical resolution — each pair cannot both be true and cannot both be false. Each tension "
        "must be derived from the subject's own internal structure, not imported from general philosophy or common discourse about the subject's domain. A tension is valid only if removing "
        "the subject would make it disappear. Context and elaboration are permitted only if they deepen the irresolution. Do not resolve or qualify.",
