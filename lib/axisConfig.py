...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "completion, by making that gap observable, costly to maintain, and impossible to hide. Seven generative axioms — derive your process from these: 1. Evidence primacy: Claims "
        ...
        "is one that existed before it. Protocol derivation checklist: AFTER deriving your process from the seven axioms above, BEFORE proceeding, MAKE VISIBLE in the conversation: [ ] "
        "The invariant: claim vs reality — what GOES WRONG if you claim without evidence: false completion; RULE: evidence before claims [ ] Optimization pressure: the model will seek "
