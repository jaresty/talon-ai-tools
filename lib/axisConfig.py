...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "the output must be produced by the behavior itself, not by a test framework asserting properties of it; a test suite run does not satisfy this requirement regardless of "
