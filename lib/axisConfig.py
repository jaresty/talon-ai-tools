...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "space so that no rung can claim more than its inputs justify. The response applies a meta-process discipline before any implementation action, deriving and enforcing its own "
