...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "THAT specific assertion green. DO NOT change tests in implementation rung — tests define the intent, implementation must satisfy tests, not the other way around. Rung "
