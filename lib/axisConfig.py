...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "completeness": {
        "deep": "The response goes into substantial depth within the chosen scope, "
        ...
        "need.",
        "narrow": "The response restricts the discussion to a very small slice of the "
    ...
    "directional": {
        "bog": (
            "The response modifies the task to examine the subject's structure and reflect on it, then "
            "identifies actions to take and extends them to related contexts."
        ),
        "dig": (
            "The response modifies the task to examine concrete details and grounding examples, focusing "
            "on specifics rather than abstractions."
        ),
        "dip bog": (
            "The response modifies the task to start with concrete examples and grounded details, "
            "examines their structure and reflects on patterns, then identify "
            "actions and extensions."
        ),
        "dip ong": (
            "The response modifies the task to start with concrete examples, identify actions to "
            "take from them, then extends those actions to related situations."
        ),
        "dip rog": (
            "The response modifies the task to examine concrete details and grounded examples, then "
            "reflects on their structural patterns and what they reveal."
        ),
        "fig": (
            "The response modifies the task to alternate between abstract principles and concrete "
            "examples, using each to illuminate the other (figure-ground reversal)."
        ),
        "fip bog": (
            "The response modifies the task to move between abstract principles and concrete examples, "
        ...
        "fly bog": (
            "The response modifies the task to identify abstract patterns and general principles, "
            "examine their structure and reflects on it, then identifies actions "
            "and extends them to related contexts."
        ),
        "fly ong": (
            "The response modifies the task to identify abstract patterns and general principles, "
            "then propose concrete actions and extends them to related contexts."
        ),
        "fly rog": (
            "The response modifies the task to identify abstract patterns and general principles, "
            "then examines their structural relationships and reflect on their "
            "implications."
        ),
        "fog": (
            "The response modifies the task to identify general patterns and abstract principles from the "
            "specifics, moving from particular cases to broader insights."
        ),
        "jog": (
            "The response modifies the task to interpret the intent and carry it out directly without "
            "asking follow-up questions."
        ),
        "ong": (
            "The response modifies the task to identify concrete actions to take, then extends those "
            "actions to related situations or next steps."
        ),
        "rog": (
            "The response modifies the task to examine the structure of the subject (how it is organized), "
    ...
    "form": {
        ...
        "steps": (
            "The response solves the problem step by step, briefly labelling and explaining "
            "each step before presenting the final answer."
        ),
        "story": (
    ...
    "method": {
        ...
        "simulation": (
            "The response enhances the task by running explicit thought experiments "
    ...
    "scope": {
        ...
        "good": "The response focuses on how quality, success, or goodness is judged—criteria, "
        ...
        "struct": "The response focuses on how things are arranged or related—dependencies, "
        "coordination, constraints, incentives, or organizing patterns.",
        "thing": "The response focuses on what things are in view—objects, people, roles, "
