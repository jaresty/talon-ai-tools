...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "tests to match implementation. Modifying tests in implementation rung voids the rung. Rung completion MUST be emitted as: ✅ [Rung name] complete — not as narrative text; the "
        "sentinel must appear after the artifact is produced and gate is satisfied; No implementation is permitted before the assertion rung shows red assertions AND the specific RAW "
