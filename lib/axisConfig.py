...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "The gap shown at Challenge is what must be addressed at Refinement to be considered complete.[ ] Structure before Challenge: derive from P1,P3 — solution organization must "
