...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "representation as its primary subject unless the chosen interpretation explicitly requires that subject. Scope classification of the primary subject must occur before "
