...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "unconstrained; CONSEQUENCE: immediate rung rejection, artifact invalidation, and meta-loop replay with visible evidence.[ ] Pre-rung rule re-emission: Derive from A3 "
        "(optimization pressure), A1 (evidence primacy) — before starting any rung, emit all key rules and consequences of rule violations relevant to that rung. Observable violation: "
        ...
        "authorization: derive from A1 (evidence primacy), A6 (execution discipline), A5 (independent evaluation) — no implementation artifact may begin until a failing "
