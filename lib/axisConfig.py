...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "exec_observed showing test suite failure + gap in current cycle; valid only at the rung whose artifact type is executable implementation]; ✅ Criteria complete — 1 criterion: "
        ...
        "shows] [gate: meta exec_observed shows no gap between observed running behavior and declared intent; all manifest threads complete].",
