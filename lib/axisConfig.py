...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "build complete components or do more than necessary; implement just enough to pass that one assertion; verify tests go green, then stop. Tests drive the behavior needed. Emit "
