...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "without errors - nothing more. Solution comes later through iteration. IMPORTANT: ADVERSARIAL posture required. For each element you add to Baseline, ask: Would removing this "
        "break evaluation? If NO, remove it. Only keep what is STRICTLY NECESSARY. Prove necessity or remove. IMPORTANT: Baseline establishes evaluation framework at Baseline. "
