...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "before the `(i)` line of the five-line block with no intervening blank lines or other content between '§ implementation permitted [N]' and the `(i)` line — a blank line, "
