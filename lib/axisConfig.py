...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        'exactly one split test: \'§ split test: property [Na]: "<verbatim canonical definition>" — falsified by <construction>; property [Nb]: "<verbatim canonical definition>" — '
        ...
        "may be accepted only while its split test, quoted definitions, falsifying constructions, and interpretation are all unchanged from the state in which the split test was "
        ...
        "derived property before being added to the retained set. If a merge or removal changes the retained property set, repeat the atomicity, completeness, and "
        "observational-independence procedures. The Ground properties block is complete only when all retained properties simultaneously satisfy: they are derived from the chosen "
