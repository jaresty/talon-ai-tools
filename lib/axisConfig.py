...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "run observation rung to re-observe the updated gap before implementing more; the scope of each implementation descent is governed by the active completeness token; the "
        "implementation-observation cycle repeats until the observed running behavior rung is satisfied. A rung is an "
