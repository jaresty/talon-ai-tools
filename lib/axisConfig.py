...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "Natural FAIL state: <yes or no> | Perturbation: <if Principle 4, describe the specific incorrect behavior to introduce; otherwise n/a>. Every assertion must have its own "
