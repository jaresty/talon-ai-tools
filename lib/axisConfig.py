...
AXIS_KEY_TO_VALUE: Dict[str, Dict[str, str]] = {
    ...
    "method": {
        ...
        "failure line does not specifically witness the violation of property [N], modify the violating state and repeat from step (4); (5) identify the governed artifact for property "
