...
COMPOSITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "prose": (
            ...
            "Test rung ladder: '§4 coverage verified' must not appear before '§ test suite "
            "complete' in the transcript. Write '§ test suite complete: [N] properties covered' "
            "only after, for each property [N] in '## Formalized properties', both of the "
            "following appear in the transcript: (a) a 'Falsify derivation:' block containing "
            "'(g) observed FAIL', and (b) the sentinel '§ test rung rejects: property [N]' "
            "immediately following that block — a '§ test rung rejects:' not immediately preceded "
            "by a 'Falsify derivation:' block containing '(g) observed FAIL' does not satisfy "
            "this requirement; [N] in '§ test suite complete: [N] properties covered' must match "
            "the count of 'property [N]:' lines in '## Formalized properties' — a count mismatch "
            "does not satisfy this requirement. '§4 coverage verified' must not appear before "
