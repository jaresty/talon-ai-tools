...
COMPOSITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "prose": (
            ...
            "artifact: <verbatim FAIL output from falsify's verification phase>' quoting the FAIL "
            "output produced by falsify's candidate-check run above this line; and 'Minimal "
