...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Challenge produces, applies, and shows the evaluative artifact failing; Refinement adds only enough to change that already-observed failing result; Verification re-applies the SAME evaluative artifact and shows that the previously observed failure no longer occurs, without introducing new drift. "
