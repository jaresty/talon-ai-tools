...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — why Baseline evaluation must APPLY and PASS to prove it works; what GOES WRONG if you declare complete without applying: no proof evaluation works; RULE: Baseline = apply evaluation and show passing output as evidence "
