...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Before starting each rung, re-emit the key rules relevant to that rung and valid transitions from your derived protocol: review your derivation to recall what that rung requires, what files are permitted, and when you may transition to other rungs (proceed downward after completing current rung, return upward when gaps found in prior rungs, one rung at a time). "
