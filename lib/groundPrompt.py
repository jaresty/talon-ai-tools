...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'for each \'property [N]:\' line, write one or more atomic sub-property lines of the form \'property [Na]:\', \'property [Nb]:\', etc., each containing a formal expression — a sub-property line whose content is prose only does not satisfy this requirement; '
