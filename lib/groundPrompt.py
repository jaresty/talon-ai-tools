...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'the intent artifact by reference, and for each item: (a) names the specific artifact in the '
        'transcript that covers it and the dimension that artifact would detect if absent, and '
        '(b) names any aspect for which no covering artifact exists. '
