...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Every file change requires justification: IMMEDIATELY AFTER each file edit, before any other tool calls, EXPLAIN WHY this change satisfies the requirements of the current rung; if you cannot justify why it satisfies the rung, ITERATE until it does; file changes without justification are protocol violations. JUSTIFICATION MUST reference the specific rung requirements being satisfied — vague explanations are insufficient. "
