...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'regardless of other goals; (2) write \'## Behavioral dimensions\' — this heading must not appear before \'## Governing goal:\' appears in the transcript; '
        'each listed dimension quotes '
