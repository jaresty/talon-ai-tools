...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'Before acting, state the boundary searched (the first message of the current session, or the '
        'specific prior message where the search began), then list every statement within that boundary '
        'that describes a desired end state. For each, state whether it subsumes the others — a goal '
        ...
        'no other goal subsumes as the anchoring citation, quoting its text and location. If multiple '
        'unsubsumed goals exist, cite all of them. '
