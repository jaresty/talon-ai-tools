...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'each \'property [N]:\' line must contain as a literal substring the longest contiguous non-bracket portion of the template in \'§ notation derived:\' that is at least 3 characters long — where the non-bracket portion is any maximal substring of the template that contains no \'[\' or \']\' character; a \'property [N]:\' line that does not contain such a substring does not satisfy this requirement; '
