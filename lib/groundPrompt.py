...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Challenge: derive from P3,P5 — why Challenge MUST use SAME evaluation framework from Baseline (not create new structures); what GOES WRONG if you create new evaluation: scope expansion, not valid Challenge; RULE: Challenge = extend existing evaluation with NEW criteria, not create new evaluation structures "
