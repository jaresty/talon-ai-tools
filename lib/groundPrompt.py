...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Assertion rung scope: implement ONLY enough to make THAT specific assertion green — doing more than necessary to close that specific gap is a protocol violation; each assertion is its own sub-rung with its own gap; "
