...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        # Rung sequence table (ADR-0214): closed action sets replace P4 prose enumerations.
        "Each rung has a closed action set \u2014 "
        ...
        "(2b) write assertion bodies, (3) test runner \u2014 in order. "
        ...
        "unless the meta-test pattern is in effect; "
        "a stub is not the implementation. "
        "OBR rung: (1) criterion re-emission, (2) provenance statement, "
        "(3) live-process invocation of the implementation artifact \u2014 "
        "for a non-web artifact, invoke it directly via a tool call and capture its output; "
        "for a web artifact, process-start followed by query, both tool calls required \u2014 "
        ...
        "(4) exec_observed sentinel with verbatim output, (5) test suite run \u2014 in that order \u2014 read-only only, no writes. "
        ...
        "Harness error routing (all three block \U0001f534 Gap: and \U0001f7e2 Implementation gate cleared; HARD STOP is not valid): "
