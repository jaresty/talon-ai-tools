...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "upward gap scan (after completing a rung, if gap remains unresolved, scan upward to find the nearest rung above that still has a gap to close; return to that rung rather than restarting from the top; continue descending from that rung to close the remaining gap; after all gaps are closed, return to the observation loop above the ladder to verify closure and emit Ground complete), "
