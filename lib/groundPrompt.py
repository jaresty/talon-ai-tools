...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "When the OBR artifact is a server process or web UI, two tool calls are required in sequence: "
        "(1) a process-start tool call, then (2) a query tool call (curl, HTTP request, or browser fetch) "
        "against the running process \u2014 "
        "the \U0001f534 Execution observed: sentinel may not be emitted until both tool calls have completed; "
        "starting the process without querying it does not satisfy this gate. "
