...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Protocol derivation checklist: AFTER deriving rules from P1-P6, BEFORE proceeding, MAKE VISIBLE the derived rules in the conversation — show what you derived about file-edit justification, stub emptiness, validation-then-assertion order, rung sequence, and gap closure — the derivation results must be in the chat, not just in your head. This checklist must appear BEFORE the first ladder rung begins. "
