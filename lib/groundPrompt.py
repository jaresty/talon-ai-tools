...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "no additional exports, no conditional logic, no non-empty bodies — and re-run, (2b) write assertion bodies, "
        ...
        "a stub is not the implementation \u2014 the EI rung must overwrite it with real behavior; "
        "leaving a stub as the final implementation artifact is a protocol violation; "
