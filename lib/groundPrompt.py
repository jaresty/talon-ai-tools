...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'Path classification: before writing \'Derived stance complete.\', write either \'Path: A\' or \'Path: B\' as the final line of the token derivation block — '
        '\'Path: A\' if an artifact that executes the subject system and returns its live output appears verbatim in the conversation above; \'Path: B\' otherwise. '
        '\'Derived stance complete.\' must not appear before \'Path: A\' or \'Path: B\' in the transcript. '
        'Derivation phase: '
        ...
        'Path B — (0) after \'Path: B\', immediately write \'§0 Path B: [scenario]\' where [scenario] names the subject '
        'from the conversation — \'§0 Path B:\' must not appear before \'Path: B\' in the transcript; this declaration satisfies §0 and opens the ladder; '
        ...
        '(2c) derive formalized properties: after \'§ formalization complete\', immediately write the label line \'Formalized properties:\' — '
