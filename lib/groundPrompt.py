...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "After validation rung, you MUST descend to the assertion rung — validation shows tests exist, assertion rung shows which specific assertions are red; the assertion rung is NOT optional; "
        ...
        "No implementation is permitted before the assertion rung shows red assertions — the exec_observed sentinel must appear with verbatim test output showing failure BEFORE any implementation code is written; the gap is the red assertion, the solution is making it green; "
