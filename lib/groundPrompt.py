...
GROUND_PARTS: dict[str, str] = {
    "epistemological_protocol": (
        ...
        "an artifact with stated open constraints is partially downward-sufficient and gates descent "
        "to the extent those constraints are resolved at the next rung; "
    ...
    "sentinel_rules": (
        ...
        "subsequent labeling; a retroactive sentinel does not open the gate \u2014 the gate remains closed. "
        ...
        "re-emit the sentinel and re-run the tool. "
        ...
        "and triggers the vacuous-green check; "
    ...
    "rung_sequence_code": (
        ...
        "each sentence containing a behavioral predicate \u2014 any action verb attributing behavior to the system "
        "(fetches, requires, displays, filters, renders, validates, authenticates, loads, saves, or similar) \u2014 "
        "must be followed inline by a bracketed thread marker: [T: gap-name]; "
        ...
        "a criterion without an explicit falsifying condition is incomplete at time of production and must not be advanced from; "
        "if the falsifying condition requires knowledge of implementation internals, the criterion is structural, "
        "not behavioral, and must be rewritten; "
        "before advancing, verify every criterion has a stated falsifying condition and is behavioral) \u2192 "
