...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'Then enumerate every path by which a transcript could satisfy the §1, §2, §3, and §4 heading '
        ...
        'does not satisfy the corresponding requirement. Proceed to implementation only when the '
        'derivation and enumeration are present as text above this point in the transcript. Any noun phrase in the governing goal that names a file path, '
