...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Every file change requires justification: AFTER creating or editing any file, EXPLAIN WHY this change satisfies the requirements of the current rung; if you cannot justify why it satisfies the rung, ITERATE until it does; file changes without justification are protocol violations. "
