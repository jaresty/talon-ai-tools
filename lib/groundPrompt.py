...
GROUND_PARTS: dict[str, str] = {
    "derivation_structure": (
        ...
        "a screenshot, preview panel, server-running confirmation, or URL response does not satisfy this rung regardless of label; "
        ...
        "before advancing from formal notation, enumerate each criterion from the criteria rung and confirm it is encoded as a behavioral invariant \u2014 "
        "list any unencoded criteria explicitly; the rung is incomplete until all are addressed. "
    ...
    "gate_validity": (
        ...
        "a passing run before gap-targeted implementation has been written is a gap signal: "
