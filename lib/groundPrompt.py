...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Implementation rung is PER assertion: each individual assertion is its own rung; implement ONLY enough to make THAT specific assertion green — doing more than necessary to close that specific gap is a protocol violation; "
