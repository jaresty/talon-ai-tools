...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — why Baseline must establish ALL evaluation mechanics needed; what GOES WRONG if you add new mechanics at Challenge: scope expands beyond intent; RULE: Baseline = all evaluation mechanics in place, Challenge extends existing mechanics with NEW criteria "
        ...
        "IMPORTANT: Baseline evaluation must PROVE it works - not just describe it. Applying and seeing it pass is the evidence. Declaring complete without applying proves nothing. "
        "IMPORTANT: Baseline establishes the evaluation MECHANICS needed for the task. All evaluation structures, validation mechanisms, or verification frameworks required must be in place BEFORE Challenge can add new criteria. New criteria added at Challenge must use the SAME mechanics, not require NEW mechanics. "
