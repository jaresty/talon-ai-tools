...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "IMPORTANT: DO NOT proceed to Challenge until Baseline PASSES. Show evidence that evaluation works without errors. If you cannot show passing evidence, fix Baseline first. "
