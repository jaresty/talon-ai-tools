...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — why evaluation scaffold must be produced and verified PASSING before Challenge; what GOES WRONG if scaffold fails at Baseline: cannot distinguish broken framework from actual gaps; RULE: Baseline evaluation scaffold must PASS before Challenge "
        ...
        "IMPORTANT: Baseline evaluation scaffold must WORK before Challenge can add new criteria. A scaffold that fails at Baseline means evaluation framework is broken, not that gaps exist. "
