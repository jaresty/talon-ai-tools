...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "executable code, component bodies, and function implementations are not valid formal notation output; "
        "if implementation code appears at this rung, the rung is void. "
