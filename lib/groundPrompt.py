...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Assertion rung: EDIT existing script to add ONE specific check (expect() assertion or shell script check); run to see it FAIL (red). NO implementation in this rung. AFTER check turns green (implementation succeeded), CHECK if gap is closed — "
