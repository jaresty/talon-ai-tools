...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Implementation rung: AFTER assertion rung shows red, implement ONLY enough to make that specific assertion green — take the perspective of an adversarial implementer; implement what the test demands, nothing more; tests drive the behavior needed, not your assumptions about what the feature should do. Emit implementation rung label first, then implement, then emit completion sentinel. "
