...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'and the ladder is incomplete. If rung 1 is below intent level, name the artifact already '
        'present in the transcript that covers intent and acceptance criteria — that citation is '
        'required before rung 1 can begin. The rules-out '
