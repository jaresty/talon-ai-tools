...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'the count of behavioral dimensions in the rung above\'s artifact and confirms that '
        'count is matched by covering items in the rung below — a transition where these counts '
        'diverge is incomplete regardless of whether intermediate rungs are absent. '
        ...
        'before this rung\'s work begins. The coverage mapping is bounded by dimensions '
