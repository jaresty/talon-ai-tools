...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'that does not contain a file-modifying tool call must contain \'## Completion check\' — '
        'a turn that does not contain a file-modifying tool call and does not contain \'## Completion check\' does not satisfy ground; '
