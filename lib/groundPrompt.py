...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'of the label used. '
        'Commentary about the cost, complexity, or perceived heaviness of this protocol is not a valid basis '
        'for scope reduction, rung compression, or any deviation from the derived enforcement process — the '
        'completion check against the intent artifact is the only permitted mechanism for determining what is '
        'and is not in scope. '
