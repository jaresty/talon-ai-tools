...
def build_ground_prompt() -> str:
    ...
    """
    return (
        "The planning phase is a state machine execution trace, not a summary or explanation. "
        ...
        "When Pending is empty: enqueue PC:PlanningComplete. "
