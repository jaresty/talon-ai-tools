...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'coverage mapping begins. The artifact '
        ...
        'a countable or boolean property of that artifact, and — for rungs that refine a rung '
        'above — the count of behavioral dimensions in the rung above\'s artifact with '
        'confirmation that the rung\'s artifact contains a covering item for each. A '
        'satisfaction condition that evaluates to true with fewer covering items than dimensions '
        'in the rung above is not satisfied. "This block contains M entries each with fields '
        'name, artifact-type, satisfaction-condition, and covering-dimension present" is valid; '
