...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Challenge: derive from P3,P5 — Challenge derives evaluation from Structure to expose gaps; RULE: Challenge = apply evaluation showing gaps exist. IMPORTANT: A gap indicates something is MISSING - nothing more. A gap saying 'component doesn't exist' means just that: it doesn't exist. It does NOT mean create the full component. "
