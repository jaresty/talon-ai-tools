...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "for each thread declared in \u2705 Manifest declared \u2014 check the thread count before emitting. "
        ...
        "is a protocol violation; subsequent criteria emerge only after the current cycle closes. "
        ...
        "prohibited: complete function bodies, variable assignments, working logic sequences; "
        ...
        "for a UI component, this means rendered browser-visible text and values; "
        ...
        "at most one thread is in progress at a time \u2014 the prose rung of thread N+1 may not begin "
