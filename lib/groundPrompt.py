...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "evidence chain (every assertion must go red then green; show red output before implementing, show green output after implementing; describing what you would do is not evidence), "
