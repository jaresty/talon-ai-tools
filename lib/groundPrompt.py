...
def build_ground_prompt() -> str:
    ...
    return (
        ...
        "Each property must be atomic. A split of a property into parts is valid only when: (a) each part can be falsified by an input that does not falsify the others, and (b) the parts have identical coverage to the original — every input that satisfies the original satisfies exactly one part, and vice versa. "
