...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'finalizing the ladder, ask at each transition: is there an intermediate artifact that '
        'would further reduce human judgment? If yes, insert it as a rung. The rules-out '
