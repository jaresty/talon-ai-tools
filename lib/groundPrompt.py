...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'Before acting, scan the transcript for the highest-level goal statement and produce a one-line '
        'anchoring citation naming its location and quoting its text. '
        'If no goal statement exists above the current point, state the transcript boundary searched. '
        'Derive the intent artifact from the cited goal statement as an enumerated list of behavioral '
