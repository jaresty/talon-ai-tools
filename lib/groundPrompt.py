...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — why Baseline establishes evaluation structure with minimal scaffolding; what GOES WRONG if Baseline IS the solution: no criteria structure exists to prove gaps; RULE: Baseline = evaluation structure (may include minimal scaffolding to hold criteria, but scaffolding is not solution) "
        ...
        "4. Baseline — Does the evaluation framework exist? Derivation: from criteria, derive evaluation structure. Evidence: evaluation structure produced and verified to work. "
        "IMPORTANT: Baseline establishes the STRUCTURE for evaluation - this may include minimal scaffolding to hold criteria. The scaffolding is NOT the solution - it's just where criteria live. "
