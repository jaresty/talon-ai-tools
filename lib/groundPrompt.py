...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        '— an [observable:] value that is only an adjective or category name does not satisfy this requirement; '
        ...
        'of the governed tool call must appear as the final non-blank content '
        ...
        'content is the literal string \'§ implementation permitted [N]\' does not satisfy this requirement. '
