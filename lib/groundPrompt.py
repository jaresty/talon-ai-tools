...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "\U0001f534 Gap: may not be emitted \u2014 there is no behavioral gap, only a missing file; "
        "the only valid next token is the executable implementation rung label; "
        ...
        "\U0001f534 Gap: may not be emitted; the only valid next token is a tool call that repairs the test file "
        "at the EV rung \u2014 not HARD STOP; "
