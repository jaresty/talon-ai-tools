...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        '\'§ formalization complete\' in the transcript, '
        ...
        '(4) verify coverage: \'## Completion check\' is valid only after \'## Enforcement sequence\' '
        'and \'§ implementation permitted\' have appeared in the transcript; '
        'immediately after \'## Completion check\', write the label line \'Formalized properties:\' — '
        'this label line is valid only after \'§ formalization complete\' has appeared in the transcript; '
        '\'§ properties complete\' is valid only after \'Formalized properties:\' has appeared in the current \'## Completion check\' block; '
        ...
        'no dimension citation, \'§ test suite complete\', or \'§4 coverage verified\' is valid until \'§ properties complete\' has appeared in the current \'## Completion check\' block; '
        'dimension citations are valid only after \'§ properties complete\' has appeared; '
        ...
        '\'§ test suite complete\' is valid only after \'§ properties complete\' has appeared in the current \'## Completion check\' block — '
        'a \'§ test suite complete\' appearing before \'§ properties complete\' or before \'## Completion check\' does not satisfy this requirement; '
        '\'§4 coverage verified\' is valid only after \'§ properties complete\' has appeared in the current \'## Completion check\' block, '
        '\'§ test suite complete\' has appeared, and every covered dimension cites such a substring; '
