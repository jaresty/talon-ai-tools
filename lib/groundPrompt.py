...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'Derivation phase: '
        '(0) before writing any task content, write \'§0: [scenario]\' where [scenario] names the subject from the conversation — '
        'this is the required opening line of the ground derivation and satisfies §0; '
        ...
        '(1) derive the governing goal: \'## Governing goal: [text]\' is valid only after \'§0: [scenario]\' has appeared earlier in the current response — a \'## Governing goal:\' line with no preceding \'§0:\' line in the current response does not satisfy this requirement; write \'## Governing goal: [text]\' — '
