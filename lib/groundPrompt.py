...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — why Baseline must establish ALL evaluation mechanics needed (may create them); what GOES WRONG if you add new mechanics at Challenge: scope expands beyond intent; RULE: Baseline = create all mechanics needed, Challenge adds NEW criteria using EXISTING mechanics"
        ...
        "IMPORTANT: Baseline establishes ALL evaluation mechanics needed for the task. These may be created at Baseline. Challenge adds NEW criteria but uses EXISTING mechanics - adding new mechanics at Challenge is scope expansion. "
