...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "For implementation code: before each file write, log the intention (target one specific assertion) and include the red observation showing that assertion currently fails; "
