...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — Baseline defines evaluation structure not solution; RULE: Baseline = evaluation structure must PASS; Prove why each element is necessary or remove it "
        ...
        "IMPORTANT: Baseline MUST PASS. If it fails, that's a broken framework - fix it. Gaps/failures are introduced at Challenge, not Baseline. "
