...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Infrastructure failures (import errors, missing files, syntax errors) are NOT assertion failures. If infrastructure fails, return UP to validation rung to fix the infrastructure issue before continuing. "
