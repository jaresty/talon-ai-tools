...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Every file change requires justification: AFTER each file edit, do NOTHING else until you have provided justification; write NO code, make NO tool calls, issue NO commands until you have explained why this change satisfies the current rung requirements; if you cannot justify why it satisfies the rung, ITERATE until it does; file changes without justification are protocol violations. JUSTIFICATION MUST reference the specific rung requirements being satisfied — vague explanations are insufficient. "
