...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        'if the split test finds no valid split (the property is already atomic), write \'property [Na]: atomic —\' followed by a formal restatement of the parent expression; '
