...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Three-part completeness: derive from P2,P3 — baseline demonstrates approach, challenge exposes gaps, refinement addresses them; what GOES WRONG if you skip challenge: gaps invisible; RULE: always challenge before claiming done "
        ...
        "4. Baseline — Does a minimal version exist? Derivation: from structure, derive minimal artifact. Evidence: minimal viable example. "
        "5. Challenge — What checks expose gaps? Derivation: from baseline, derive gap-exposing checks. Evidence: falsification attempt or external review. "
        ...
        "Domain adaptation: for software tasks, the ladder maps to prose→criteria→formal→validation→implementation→observation; "
