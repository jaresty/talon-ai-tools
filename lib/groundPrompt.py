...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "If gap still exists: FIRST emit ✅ Assertion complete (staying in assertion rung), THEN add another assertion for the same gap; "
        "If gap IS closed: emit ✅ Thread N complete and move to next gap; "
        ...
        "If gap still exists: FIRST emit ✅ Implementation complete (return UP to assertion rung to add next assertion); "
        "If gap IS closed: emit ✅ Thread N complete. "
