...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "[ ] Baseline: derive from P2,P3 — why Baseline must prove evaluation works before proceeding; what GOES WRONG if you skip proving it works: no proof framework is valid; RULE: Baseline = prove evaluation works (apply and show passing output), cannot proceed without this proof"
