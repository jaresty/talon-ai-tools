...
GROUND_PARTS_MINIMAL: dict[str, str] = {
    "core": (
        ...
        "Implementation rung: AFTER assertion rung shows red, implement to make that specific assertion green — this will build the COMPLETE component needed to satisfy that assertion (not just stub); take the perspective of an adversarial implementer; implement what the test demands; tests drive the behavior needed. Emit implementation rung label first, then implement, then emit completion sentinel. "
