...
GUIDEBOOK: list[dict[str, Any]] = [
...

    {
        ...
        "body": (
            ...
            "**crystal** — *restructures the artifact itself*: the system is changed so behavior is "
            "determined by explicit structure rather than convention. You are modifying the thing, not "
            "re-reading it. Output is a redesigned artifact.\n\n"
            ...
            "If you want to change the thing so it behaves differently → `crystal`. "
