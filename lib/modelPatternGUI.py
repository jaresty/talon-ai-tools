...
PATTERNS: list[PromptPattern] = [
    ...
    PromptPattern(
        ...
        recipe="show · gist · struct · slack · fog",
        domain="writing",
    ),
    PromptPattern(
        name="Jira ticket",
        description="Draft a Jira-style ticket description for this issue.",
        recipe="show · full · act · steps · story · jira · fog",
        domain="writing",
    ),
    PromptPattern(
        name="Motif scan",
    ...
    PromptPattern(
        ...
        recipe="show · gist · fail · adversarial · fog",
        domain="writing",
    ),
    PromptPattern(
        name="Systems path",
        description="Outline a short systems-level path from here to a desired outcome.",
        recipe="show · gist · struct · systemic · mapping · ong",
        domain="writing",
    ),
]
