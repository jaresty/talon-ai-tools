<script lang="ts">
	...
	import { loadGrammar, getAxisTokens, getTaskTokens, getPersonaPresets, getPersonaAxisTokensMeta, getPresetHint, toPersonaSlug, toAxisTokenSlug, buildCommandTokens, AXES, type Grammar, type GrammarPattern, type StarterPack, getUsagePatterns, getStarterPacks, getSequences } from '$lib/grammar.js';
...
<div class="layout" bind:this={layoutEl} style:padding-bottom="{reviewPanelHeight + 16}px" style:--review-h="{reviewPanelHeight + 16}px">
	...
	{#if activeMode === 'sequences' && grammar}
